...
async function renderModels()
{
    try
    {
        ...
        {
            models.sort((model1, model2) => model2.rating - model1.rating)
        }
        else if (modelsSort === "HIGH_TO_LOW")
        {
            models.sort((model1, model2) => model2.per_day_price - model1.per_day_price)
        }
        else if (modelsSort === "LOW_TO_HIGH")
        {
            models.sort((model1, model2) => model1.per_day_price - model2.per_day_price)
        }
